...
function Devotional() {
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <h1 className="text-2xl font-semibold mb-6">Devotional</h1>
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {Array.isArray(devotionalBlogs) && devotionalBlogs.length > 0 ? (
            devotionalBlogs.slice(0, 10).map((element) => (
              <Link
                to={`/blog/${element._id}`}
              ...
              >
                ...
                {/* Author Info */}
                <div className="p-6 flex items-center bg-orange-400">
                  <img
